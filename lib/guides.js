...
const statesAboveVisible = (cursorRows, start, getIndentFn, lastRow) => statesInvisible(cursorRows, start, getIndentFn, lastRow, true)

const statesBelowVisible = (cursorRows, start, getIndentFn, lastRow) => statesInvisible(cursorRows, start, getIndentFn, lastRow, false)
...
module.exports = { toGuides, uniq, getGuides, statesAboveVisible, statesBelowVisible }

...
export function styleGuide(element, point, length, stack, active, editor, basePixelPos, lineHeightPixel, baseScreenRow) {
...
export function createElementsForGuides(editorElement, fns) {
